        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-2">
                <a @click="smoothScroll('#home')"
                    ...
                    <img src="../../images/Seal_of_Nankai_University.svg.png" alt="Nankai Seal" width="103"
                        height="103" />
                    <h4 class="font-medium text-3xl text-surface-900 dark:text-surface-0">NANKAI</h4>
                </a>
            </div>
